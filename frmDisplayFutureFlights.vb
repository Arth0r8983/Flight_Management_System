Public Class frmDisplayFutureFlights
    Private Sub frmDisplayFutureFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            ' ---------------------
            cmdSelect = New OleDb.OleDbCommand("uspListPassengerFutureFlights", m_conAdministrator)
            ...
            lstFutureFlights.Items.Add("List of All Future Flights of Passenger")
            ...
            ' Stored Procedure Enhancement
            ' ---------------------
            cmdSelect = New OleDb.OleDbCommand("uspFuturePassengerFlightMiles", m_conAdministrator)
            cmdSelect.CommandType = CommandType.StoredProcedure
