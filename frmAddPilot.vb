Public Class frmAddPilot
    Private Sub frmAddPilot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cboPilotRole.DataSource = dtPilotRole
    ...
    Private Sub btnAddPilot_Click(sender As Object, e As EventArgs) Handles btnAddPilot.Click
        ...
        If blnValidated = True Then
            Try
                ...
                cmdAddPilot.CommandText = "EXECUTE uspAddPilots '" & intPKID & "','" & intPKID2 & "','" & strFirstName & "','" & strLastName & "','" & strEmployeeID & "','" & dtmHireDate & "','" & dtmTerminationDate & "','" & dtmLicenseDate & "','" & intPilotRole & "','" & strPilotLoginID & "','" & strPilotPassword & "','" & intPKID3 & "'"
                ...
                If intRowsAffected > 0 Then
                    MessageBox.Show("Insert successful Pilot " & strLastName & " has been added.")
