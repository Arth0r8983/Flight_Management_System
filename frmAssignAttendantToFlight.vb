Public Class frmAssignAttendantToFlight
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        result = MessageBox.Show("Are you sure you want To assign this flight On " & cboFlights.Text & " For Attendant " & cboAttendantNames.Text & "?", "Confirm Flight", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
        ...
        Select Case result
            ...
            " VALUES (" & intNextPrimaryKey & "," & cboAttendantNames.SelectedValue & "," & intFlight & ")"
                  ...
                  '  MessageBox.Show(strInsert)
                    ...
                    If intRowsAffected > 0 Then
                        MessageBox.Show("flight has been assigned to Attendant")    ' let user know success
