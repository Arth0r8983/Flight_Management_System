Public Class frmAdminUpdatePilot
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        Close()

    End Sub

    Private Sub frmAdminUpdatePilot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnUpdatePilot_Click(sender As Object, e As EventArgs) Handles btnUpdatePilot.Click
        intPilot = cboPilotNames.SelectedValue
